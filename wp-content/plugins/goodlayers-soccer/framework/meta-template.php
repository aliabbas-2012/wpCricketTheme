...
function gdlr_lms_print_meta_box($settings) {
    ...
    switch ($settings['type']) {
        case 'text': gdlr_lms_print_text_input($settings);
            break;
        case 'number': gdlr_lms_print_text_input($settings);
            break;
        case 'textarea': gdlr_lms_print_textarea($settings);
            break;
        case 'combobox': gdlr_lms_print_combobox($settings);
            break;
        case 'checkbox': gdlr_lms_print_checkbox($settings);
            break;
        case 'datepicker': gdlr_lms_print_datepicker($settings);
            break;
        case 'wysiwyg': gdlr_lms_print_wysiwyg($settings);
            break;
        case 'question': gdlr_lms_print_question($settings);
            break;
    }
...
function gdlr_lms_print_text_input($settings) {
    ...
    $field_input_type = ($settings['type'] == "number") ? "number" : "text";
    echo '<input type="' . $field_input_type . '" class="gdl-text-input ' . $settings['class'] . '" data-slug="' . $settings['slug'] . '" ';
